...
{	
	...
	//atributos de referência - a principio não é necessário
	Paciente pac;	
	Endereco end;
	Telefone fone;
	...
	public TelaPaciente()
	{
		...
		pPessoal.setBorder
		(	BorderFactory.createTitledBorder("Dados Pessoais do Paciente:")	);
		
		pEndereco = new JPanel();
		pEndereco.setSize(680, 240);
		pEndereco.setLocation(10, 260);
		pEndereco.setBorder
		(	BorderFactory.createTitledBorder("Endereço Completo:")	);
		...
		class BatSinal extends MouseAdapter {
			public void mouseClicked(MouseEvent e) {
				if (e.getSource() == bSalvar) {
					...
					pac = new Paciente(nome,email,cpf,dtNasc,peso,altura,idade,end,fone);
